...
export const algorithms: { [key: string]: AlgorithmData } = {
  "newton-raphson": {
    ...
    comparison: { speed: 4, accuracy: 8, convergence: 3, powerLoss: 2 },
  ...
  "gauss-seidel": {
    ...
    comparison: { speed: 6, accuracy: 8, convergence: 6, powerLoss: 8 },
    run: runGaussSeidel,
    maxIterations: 15,
  },
  "dc-power-flow": {
    ...
    comparison: { speed: 4, accuracy: 2, convergence: 4, powerLoss: 2 },
    run: runDCPowerFlow,
    maxIterations: 1,
  },
  "fast-decoupled": {
    ...
    comparison: { speed: 4, accuracy: 4, convergence: 4, powerLoss: 7 },
